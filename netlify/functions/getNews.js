...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    // Use the 2026 interactions API
    const interaction = await ai.interactions.create({
      model: 'gemini-3-flash',
      input: `Interests: ${prefs.interests}. Filter and summarize these: ${JSON.stringify(articles)}. Return ONLY a JSON array. Use Malayalam for India news, English for global tech. Avoid translation errors.`
    });
